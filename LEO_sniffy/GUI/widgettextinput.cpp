    ...
    ui(new Ui::WidgetTextInput)
{
    ...
    style = "QWidget:disabled{color: "+QString::fromUtf8(COLOR_GREY)+";} QWidget{background-color:"+Colors::getDataAreaColor()+";color:"+QString::fromUtf8(COLOR_WHITE) +";}";
...
bool WidgetTextInput::eventFilter(QObject *obj, QEvent *event){
    ...
    if(processTextEdit){
        ui->lineEdit->setStyleSheet(QString::fromUtf8(" QLineEdit{ background-color:")+Colors::getDataAreaColor()+";}");
        processInput();
    }
